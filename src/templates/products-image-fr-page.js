...
export const ProductsImageFrPageTemplate = ({
  image,
  tables,
  html,
  lang
...
ProductsImageFrPageTemplate.propTypes = {
...
const ProductsImageFrPage = ({ data }) => {
...
export default ProductsImageFrPage

export const pageQuery = graphql`
query ProductsImageFrPageTemplate($id: String!) {
